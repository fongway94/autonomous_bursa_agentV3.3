...
- **Risk-Aware Contextual Gaussian Thompson Sampling (GTS) [v4 Milestone]:** Upgrade the US Swing & US Intraday brains to NIG continuous R-multiple return modeling and linear contextual bandits, optimizing directly for Sharpe/Sortino Ratios. (To be implemented after Block 8 and collecting 200+ closed US trades).
